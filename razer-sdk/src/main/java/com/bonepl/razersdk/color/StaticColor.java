...
public record StaticColor(int red, int green, int blue) implements Color {
    public static final Color NONE = new StaticColor(0, 0, 0);

    public static final Color WHITE = new StaticColor(255, 255, 255);
    public static final Color RED = new StaticColor(255, 0, 0);
    public static final Color GREEN = new StaticColor(0, 255, 0);
    public static final Color BLUE = new StaticColor(0, 0, 255);
    public static final Color BLACK = new StaticColor(0, 0, 0);
    public static final Color YELLOW = new StaticColor(255, 255, 0);
    public static final Color CYAN = new StaticColor(0, 255, 255);
    public static final Color BROWN = new StaticColor(130, 50, 0);
    public static final Color PURPLE = new StaticColor(200, 0, 200);
    public static final Color ORANGE = new StaticColor(255, 165, 0);
    public static final Color GRAY = new StaticColor(100, 100, 100);
