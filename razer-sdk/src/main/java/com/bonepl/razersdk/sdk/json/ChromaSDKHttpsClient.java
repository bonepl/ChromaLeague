...
public final class ChromaSDKHttpsClient {
    private static final Logger LOGGER = Logger.getLogger(ChromaSDKHttpsClient.class.getName());
    public static final int DEFAULT_TIMEOUT = 5000;

    private ChromaSDKHttpsClient() {
    }
